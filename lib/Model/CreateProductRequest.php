...
class CreateProductRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        ...
        'inventory_reason' => 'setInventoryReason',
    ...
    protected static $getters = [
        ...
        'inventory_reason' => 'getInventoryReason',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('inventory_reason', $data ?? [], null);
     ...
     *
     * @param float|null $initial_quantity initial_quantity
     *
     * @return self
     */
    ...
    /**
     * Gets inventory_reason
     *
     * @return string|null
     */
    public function getInventoryReason()
    {
        return $this->container['inventory_reason'];
    }

    /**
     * Sets inventory_reason
     *
     * @param string|null $inventory_reason inventory_reason
     *
     * @return self
     */
    public function setInventoryReason($inventory_reason)
    {
        if (is_null($inventory_reason)) {
            array_push($this->openAPINullablesSetToNull, 'inventory_reason');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('inventory_reason', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['inventory_reason'] = $inventory_reason;
