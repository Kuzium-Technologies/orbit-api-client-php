...
/**
 * PagedResultOfCustomerResponse Class Doc Comment
 *
 * @category Class
 * @package  KuziumOrbitClient
 * @author   OpenAPI Generator team
 ...
 */
class PagedResultOfCustomerResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PagedResultOfCustomerResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\KuziumOrbitClient\Model\CustomerResponse[]',
        'total_count' => 'int',
        'current_page' => 'int',
        'page_size' => 'int',
        'total_pages' => 'int'
     ...
     * Sets items
     *
     * @param \KuziumOrbitClient\Model\CustomerResponse[] $items items
     *
     * @return self
     */
