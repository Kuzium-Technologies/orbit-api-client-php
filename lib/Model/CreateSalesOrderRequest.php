...
/**
 * CreateSalesOrderRequest Class Doc Comment
 *
 * @category Class
 * @package  KuziumOrbitClient
 * @author   OpenAPI Generator team
 ...
 */
class CreateSalesOrderRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateSalesOrderRequest';
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['order_number'] === null && !$this->isNullableSetToNull('order_number')) {
            $invalidProperties[] = "'order_number' is required";
        }
