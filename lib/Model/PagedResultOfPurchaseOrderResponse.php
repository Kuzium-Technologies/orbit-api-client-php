...
/**
 * PagedResultOfPurchaseOrderResponse Class Doc Comment
 *
 * @category Class
 * @package  KuziumOrbitClient
 * @author   OpenAPI Generator team
 ...
 */
class PagedResultOfPurchaseOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PagedResultOfPurchaseOrderResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\KuziumOrbitClient\Model\PurchaseOrderResponse[]',
        'total_count' => 'int',
        'current_page' => 'int',
        'page_size' => 'int',
        'total_pages' => 'int'
     ...
     * Sets items
     *
     * @param \KuziumOrbitClient\Model\PurchaseOrderResponse[] $items items
     *
     * @return self
     */
