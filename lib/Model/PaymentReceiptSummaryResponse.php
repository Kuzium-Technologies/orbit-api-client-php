...
/**
 * PaymentReceiptSummaryResponse Class Doc Comment
 *
 * @category Class
 * @package  KuziumOrbitClient
 * @author   OpenAPI Generator team
 ...
 */
class PaymentReceiptSummaryResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PaymentReceiptSummaryResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('total_receipts', $data ?? [], null);
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['total_receipts'] === null) {
            $invalidProperties[] = "'total_receipts' can't be null";
        }
     ...
     * Sets total_payments
     *
     * @param float $total_payments total_payments
     *
     * @return self
     */
     ...
     * Sets total_receipts
     *
     * @param float $total_receipts total_receipts
     *
     * @return self
     */
    public function setTotalReceipts($total_receipts)
    {
        if (is_null($total_receipts)) {
            throw new \InvalidArgumentException('non-nullable total_receipts cannot be null');
        }
