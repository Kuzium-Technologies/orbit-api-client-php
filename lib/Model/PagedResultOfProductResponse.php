...
/**
 * PagedResultOfProductResponse Class Doc Comment
 *
 * @category Class
 * @package  KuziumOrbitClient
 * @author   OpenAPI Generator team
 ...
 */
class PagedResultOfProductResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'PagedResultOfProductResponse';
    ...
    protected static $openAPITypes = [
        'items' => '\KuziumOrbitClient\Model\ProductResponse[]',
        'total_count' => 'int',
        'current_page' => 'int',
        'page_size' => 'int',
        'total_pages' => 'int'
     ...
     * Sets items
     *
     * @param \KuziumOrbitClient\Model\ProductResponse[] $items items
     *
     * @return self
     */
